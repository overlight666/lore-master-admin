        ...
        <div className="mt-4 p-3 bg-yellow-50 rounded-lg flex items-start">
          ...
          <div className="text-sm text-yellow-800">
            ...
            <ul className="mt-1 list-disc list-inside space-y-1">
              <li>Questions will be automatically assigned to this category</li>
              <li>Duplicate questions (same text) will be skipped</li>
              <li>Invalid questions will be reported in the results</li>
