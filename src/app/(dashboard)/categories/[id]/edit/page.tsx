...
import { CategoryFormData, Category, Topic, Subtopic } from '@/types';
...
export default function EditCategoryPage() {
  ...
  const fetchCategory = async () => {
    try {
      const category: Category = await categoriesApi.getById(categoryId);
      setFormData({
        subtopic_id: category.subtopic_id,
